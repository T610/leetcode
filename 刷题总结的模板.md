...
=======
## 双指针
一般的双指针有快慢两个指针，可以是从两边往中间走 如 [167. 两数之和 II - 输入有序数组](https://leetcode-cn.com/problems/two-sum-ii-input-array-is-sorted/) ， [977. 有序数组的平方](https://leetcode-cn.com/problems/squares-of-a-sorted-array/)   或者